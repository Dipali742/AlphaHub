                                    ...
                                    <td style="width: 30%">
                                        <div class="dropdown d-flex">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a class="dropdown-item" href="<?php echo e(url("online-exam/".$online_exam->id.'/edit')); ?>"><?php echo app('translator')->get('lang.edit'); ?></a>

                                                <?php endif; ?>
                                                <?php if(in_array(241, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>

                                                <a class="dropdown-item deleteOnlineExam" data-toggle="modal" href="#" data-id="<?php echo e($online_exam->id); ?>" data-target="#deleteOnlineExam"><?php echo app('translator')->get('lang.delete'); ?></a>
                                                <?php endif; ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u642648155/domains/alphahub.in/public_html/resources/views/backEnd/examination/online_exam.blade.php ENDPATH**/ ?>