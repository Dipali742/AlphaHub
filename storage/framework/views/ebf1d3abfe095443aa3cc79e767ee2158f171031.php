          ...
          <table id="table_id" class="display school-table" cellspacing="0" width="100%">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <div class="dropdown">
                    <a class="primary-btn fix-gr-bg" href="<?php echo e(url('issue-books/'.$value->member_type.'/'.$value->student_staff_id)); ?>"><?php echo app('translator')->get('lang.issue_return_Book'); ?></a>
                  </div>
                </td>
                  </tr>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u642648155/domains/alphahub.in/public_html/resources/views/backEnd/library/memberLists.blade.php ENDPATH**/ ?>