                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                         ...
                                         <a class="dropdown-item" href="<?php echo e(url('event/'.$value->id.'/edit')); ?>"><?php echo app('translator')->get('lang.edit'); ?></a>
                                        <?php endif; ?>
                                         <?php if(in_array(297, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1  ): ?>
                                          <a class="deleteUrl dropdown-item" data-modal-size="modal-md" title="Delete Event" href="<?php echo e(url('delete-event-view/'.$value->id)); ?>"><?php echo app('translator')->get('lang.delete'); ?></a>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </td>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u642648155/domains/alphahub.in/public_html/resources/views/backEnd/events/eventsList.blade.php ENDPATH**/ ?>