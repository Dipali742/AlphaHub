                                    ...
                                    <div class="row mb-25">
                                        ...
                                        <div class="col-lg-12 mb-30">
                                            <select
                                                ...
                                                <option value="as"> <?php echo app('translator')->get('lang.assignment'); ?></option>
                                                
                                                <option value="sy"><?php echo app('translator')->get('lang.syllabus'); ?></option>
                                                <option value="ot"><?php echo app('translator')->get('lang.other_download'); ?></option>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if(@$value->available_for_admin == 1): ?>
                                                    <?php echo e('All Teachers'); ?><br><?php echo e('All Students'); ?>

                                                <?php endif; ?>
                                                <!--<?php if(@$value->available_for_all_classes == 1): ?>-->
                                                <!--    <?php echo e('All Students'); ?>-->
                                                <!--<?php endif; ?>-->
                                            </td>
                                            <!--<td>-->
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u642648155/domains/alphahub.in/public_html/resources/views/backEnd/teacher/uploadContentList.blade.php ENDPATH**/ ?>