...
<section class="admin-visitor-area up_st_admin_visitor">
 ...
 <?php if(in_array(310, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
                            <a class="primary-btn fix-gr-bg" href="<?php echo e(url('cancel-membership/'.$value->id)); ?>"><?php echo app('translator')->get('lang.cancel'); ?> <?php echo app('translator')->get('lang.membership'); ?></a>
                         <?php endif; ?>
                        </div>
                        </td>
                    </tr>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u642648155/domains/alphahub.in/public_html/resources/views/backEnd/library/members.blade.php ENDPATH**/ ?>