                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 no-gutters">
                            <div class="main-title">
                                <h3 class="mb-30"><?php echo app('translator')->get('lang.student_attendance'); ?> | <small><?php echo app('translator')->get('lang.class'); ?>: <?php echo e($search_info['class_name']); ?>, <?php echo app('translator')->get('lang.section'); ?>: <?php echo e($search_info['section_name']); ?>, <?php echo app('translator')->get('lang.date'); ?>: <?php echo e(App\SmGeneralSettings::DateConvater($search_info['date'])); ?></small></h3>
                            </div>
                        </div>
                    </div>
                    <div class="row">
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u642648155/domains/alphahub.in/public_html/resources/views/backEnd/studentInformation/student_attendance.blade.php ENDPATH**/ ?>